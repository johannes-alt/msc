...
The cell is filled with the liquid scintillator \ac{lab} which is also planed to be used in the \ac{sbt}.
...
The bandgap voltage $V_\text{bg}$ of the comparators, which can be adjsuted in eight steps, to one of the values V_\text{bg}&=\SIlist{487.22;730.92;974.62;1218.3;1462.0;1705.7;1949.4;2436.8}{\milli\volt}.
